...
import { CATALOGO_NOTIFICACIONES_APLICACION } from './catalogo-notificaciones-aplicacion.js';
export function renderizarVistaNotificacionesAplicacion(){
  return e('section',{clase:'pagina-desplazable pagina-angosta'},[
    ...
    e('div',{clase:'lista-notificaciones'},CATALOGO_NOTIFICACIONES_APLICACION.map(n=>e('article',{clase:'tarjeta-notificacion'},[
